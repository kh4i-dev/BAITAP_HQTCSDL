...
![1. Sơ đồ ERD Quản lý cầm đồ](images_bt_03/1.png)

### 2.2. Cài đặt các bảng dữ liệu (3NF)
**Bảng 1: Khách hàng (dbo.KhachHang)**
![2. Cấu trúc bảng Khách hàng](images_bt_03/2.png)
```sql
...
![3. Cấu trúc bảng Nhân viên](images_bt_03/3.png)
```sql
...
![4. Cấu trúc bảng Hợp đồng](images_bt_03/4.png)
```sql
...
![5. Cấu trúc bảng Tài sản](images_bt_03/5.png)
```sql
...
![6. Cấu trúc bảng Log](images_bt_03/6.png)
```sql
...
![7. Cấu trúc bảng Lịch sử](images_bt_03/7.png)
```sql
...
![8. Lệnh tạo Stored Procedure sp_RegisterContract](images_bt_03/sp_RegisterContract.png)
...
![10. Lệnh tạo Stored Procedure sp_ProcessPayment](images_bt_03/sp_ProcessPayment.png)
...
![11. Lệnh tạo View vw_BadDebts](images_bt_03/vw_BadDebts.png)
...
![12. Lệnh tạo Trigger trg_Event5_Workflow](images_bt_03/trg_Event5_Workflow.png)
...
![13. Lệnh tạo Stored Procedure sp_RenewContract](images_bt_03/sp_RenewContract.png)
...
![14. Lệnh tạo Stored Procedure sp_GetContractHistory](images_bt_03/sp_GetContractHistory.png)
