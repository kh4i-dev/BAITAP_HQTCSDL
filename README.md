...
![3. Cấu trúc bảng Nhân viên](images1/3.png)
```sql
...
![4. Cấu trúc bảng Hợp đồng](images1/4.png)
```sql
...
![5. Cấu trúc bảng Tài sản](images1/5.png)
```sql
...
![6. Cấu trúc bảng Log](images1/6.png)
```sql
...
![7. Cấu trúc bảng Lịch sử](images1/7.png)
```sql
...
![8. Lệnh tạo Stored Procedure sp_RegisterContract](images1/sp_RegisterContract.png)
...
![9. Lệnh tạo Hàm fn_CalcMoneyTransaction và fn_CalcMoneyContract](images1/fn_CalcMoneyTransaction.png)
...
![10. Lệnh tạo Stored Procedure sp_ProcessPayment](images1/sp_ProcessPayment.png)
...
![11. Lệnh tạo View vw_BadDebts](images1/vw_BadDebts.png)
...
![12. Lệnh tạo Trigger trg_Event5_Workflow](images1/trg_Event5_Workflow.png)
...
![13. Lệnh tạo Stored Procedure sp_RenewContract](images1/sp_RenewContract.png)
...
![14. Lệnh tạo Stored Procedure sp_GetContractHistory](images1/sp_GetContractHistory.png)
